...
class RegisterPetugasActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_datepicker.setOnClickListener {
            ...
            datePicker.addOnPositiveButtonClickListener {
                ...
                edt_tl_petugas_register.setText(tanggal)
        ...
        auth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(this) {
                if (it.isSuccessful) {
                    ...
                    database.child("Petugas").child(auth.uid.toString()).setValue(petugas)
                        .addOnCompleteListener {
                            Toast.makeText(this, "Register Berhasil", Toast.LENGTH_SHORT).show()
                            val intent = Intent(
                                this@RegisterPetugasActivity,
                                DaftarPetugasActivity::class.java
                            )
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.mi_profil) {
            ...
            val intent =
                Intent(this@RegisterPetugasActivity, DaftarPasienTerdaftarActivity::class.java)
            startActivity(intent)
